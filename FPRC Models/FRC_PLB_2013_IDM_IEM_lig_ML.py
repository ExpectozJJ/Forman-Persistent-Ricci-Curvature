...
X_train_1 = np.load("ORC PLB IDM 2013/forman_train_set_2013_IDM_model_4.npy", allow_pickle=True)
X_test_1 = np.load("ORC PLB IDM 2013/forman_test_set_2013_IDM_model_4.npy", allow_pickle=True)
X_train_2 = np.load("ORC PLB IEM 2013/forman_train_set_2013_IEM_model_4.npy", allow_pickle=True)
X_test_2 = np.load("ORC PLB IEM 2013/forman_test_set_2013_IEM_model_4.npy", allow_pickle=True)

X_train_3 = np.load("ORC PLB IDM 2013/lig_C_2013_forman_IDM_train.npy", allow_pickle=True)
X_test_3 = np.load("ORC PLB IDM 2013/lig_C_2013_forman_IDM_test.npy", allow_pickle=True)
X_train_4 = np.load("ORC PLB IDM 2013/lig_CN_2013_forman_IDM_train.npy", allow_pickle=True)
X_test_4 = np.load("ORC PLB IDM 2013/lig_CN_2013_forman_IDM_test.npy", allow_pickle=True)
X_train_5 = np.load("ORC PLB IDM 2013/lig_CO_2013_forman_IDM_train.npy", allow_pickle=True)
X_test_5 = np.load("ORC PLB IDM 2013/lig_CO_2013_forman_IDM_test.npy", allow_pickle=True)
X_train_6 = np.load("ORC PLB IDM 2013/lig_CNO_2013_forman_IDM_train.npy", allow_pickle=True)
X_test_6 = np.load("ORC PLB IDM 2013/lig_CNO_2013_forman_IDM_test.npy", allow_pickle=True)
X_train_7 = np.load("ORC PLB IDM 2013/lig_CNOSFPClBrI_2013_forman_IDM_train.npy", allow_pickle=True)
X_test_7 = np.load("ORC PLB IDM 2013/lig_CNOSFPClBrI_2013_forman_IDM_test.npy", allow_pickle=True)
...
np.save("ORC PLB IEM 2013/forman_results_2013_IDM_IEM_lig_multiscale_model_4.npy", [results, gbt_values, rf_values])