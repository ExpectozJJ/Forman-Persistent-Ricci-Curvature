...
for comb in comb_d:
    ...
    cnt = 0
    for t in test_list:
        [orc_temp, frc_temp] = nx.read_gpickle("ORC PLB IDM 2016/lig_IDM_graphs/"+t+"_15_"+comb+"_ligand.gpickle")
        ...
        cnt += 1
    np.save("ORC PLB IDM 2016/lig_"+comb+"_2016_ollivier_IDM_test.npy", test_set)
    ...
    for t in test_list:
        ...
        test_set.append(temp_feature)
        cnt += 1
    np.save("ORC PLB IDM 2016/lig_"+comb+"_2016_forman_IDM_test.npy", test_set)
    ...
    for t in train_list:
        ...
        cnt += 1
    np.save("ORC PLB IDM 2016/lig_"+comb+"_2016_ollivier_IDM_train.npy", train_set)
    ...
    for t in train_list:
        ...
        train_set.append(temp_feature)
        cnt += 1
    np.save("ORC PLB IDM 2016/lig_"+comb+"_2016_forman_IDM_train.npy", train_set)