...
X_train_1 = np.load("ORC PLB IDM 2007/forman_train_set_2007_IDM_model_4.npy", allow_pickle=True)
X_test_1 = np.load("ORC PLB IDM 2007/forman_test_set_2007_IDM_model_4.npy", allow_pickle=True)
...
X_train_3 = np.load("ORC PLB IDM 2007/lig_C_2007_forman_IDM_train.npy", allow_pickle=True)
X_test_3 = np.load("ORC PLB IDM 2007/lig_C_2007_forman_IDM_test.npy", allow_pickle=True)
X_train_4 = np.load("ORC PLB IDM 2007/lig_CN_2007_forman_IDM_train.npy", allow_pickle=True)
X_test_4 = np.load("ORC PLB IDM 2007/lig_CN_2007_forman_IDM_test.npy", allow_pickle=True)
X_train_5 = np.load("ORC PLB IDM 2007/lig_CO_2007_forman_IDM_train.npy", allow_pickle=True)
X_test_5 = np.load("ORC PLB IDM 2007/lig_CO_2007_forman_IDM_test.npy", allow_pickle=True)
X_train_6 = np.load("ORC PLB IDM 2007/lig_CNO_2007_forman_IDM_train.npy", allow_pickle=True)
X_test_6 = np.load("ORC PLB IDM 2007/lig_CNO_2007_forman_IDM_test.npy", allow_pickle=True)
X_train_7 = np.load("ORC PLB IDM 2007/lig_CNOSFPClBrI_2007_forman_IDM_train.npy", allow_pickle=True)
X_test_7 = np.load("ORC PLB IDM 2007/lig_CNOSFPClBrI_2007_forman_IDM_test.npy", allow_pickle=True)
...
X2 = pca.transform(X_test) # transform test set using the fitted PCA model from training set
...
# GBT
    ...
    clf.fit(X1, Y_train)
    mse = mean_squared_error(Y_test, clf.predict(X2))
    pearcorr = sp.stats.pearsonr(Y_test, clf.predict(X2))
    ...
    gbt_values.append(clf.predict(X2))
#print("Filtration Param: ", fp)
...
"""
np.save("ORC PLB IEM 2007/forman_results_2007_IDM_IEM_lig_multiscale_with_pca_model_4.npy", [results, gbt_values, rf_values])
