...
X_train_1 = np.load("ORC PLB IDM 2016/forman_train_set_15_model_4.npy", allow_pickle=True)
X_test_1 = np.load("ORC PLB IDM 2016/forman_test_set_15_model_4.npy", allow_pickle=True)
X_train_2 = np.load("ORC PLB IEM 2016/forman_train_set_10_model_4.npy", allow_pickle=True)
X_test_2 = np.load("ORC PLB IEM 2016/forman_test_set_10_model_4.npy", allow_pickle=True)
...
np.save("ORC PLB IEM 2016/forman_results_2016_IDM_IEM_model_4.npy", [results, gbt_values, rf_values])